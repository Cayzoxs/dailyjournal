...
if ($check_gallery && $check_gallery->num_rows > 0) {
    // Jika tabel ada → jalankan query
    $sql2 = "SELECT * FROM gallery ORDER BY tanggal DESC";
    $hasil2 = $conn->query($sql2);
    $jumlah_gallery = $hasil2->num_rows;
} else {
    // Jika tabel tidak ada → set ke 0 agar tidak error
    $jumlah_gallery = 0;
}
?>
<div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center pt-4">
    <div class="col">
        <div class="card border border-danger mb-3 shadow" style="max-width: 18rem; min-height: 130px;">
            <div class="card-body">
